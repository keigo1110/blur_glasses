...
def process_images(detector, input_folder, output_folder):
    """
    Process all images in the input folder and save results to the output folder.

    Args:
        detector (ObjectDetector): Instance of the ObjectDetector class.
...
def main():
    ...
    print("\nProcessing images in the folder...")
    process_images(detector, input_folder, output_folder)
